document.addEventListener('DOMContentLoaded', function () {
    ...
    galleries.forEach(function (gallery) {
        ...
        function switchTo(index) {
            ...
            var width = thumb.getAttribute('data-pulp-width');
            var height = thumb.getAttribute('data-pulp-height');
            
            spinner.hidden = false;
            main.classList.remove('pulp-fade-in');
            
            // Update dimensions BEFORE changing src to prevent layout shift
            if (width && height) {
